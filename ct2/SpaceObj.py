...
class SpaceObj:
    ...
    # Oh.  This should actually align it in the right direction.
    # And double-check it moves to the right location while you're at it...
    # Or moves it back to the original position, or whatever...
    # Make all location relative to some zero point, at least.
    def draw( s ):
        quad = gluNewQuadric()
        gluQuadricNormals( quad, GLU_SMOOTH )
        gluQuadricTexture( quad, GL_FALSE )

        theta, vec = s.facing.toAxis()
